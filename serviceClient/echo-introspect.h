...
#ifndef __dbusxx__echo_introspect_h__PROXY_MARSHAL_H
#define __dbusxx__echo_introspect_h__PROXY_MARSHAL_H
...
public:
    ...
    iface_proxy()
    : ::DBus::InterfaceProxy("test.iface")
    {
        connect_signal(iface_proxy, Echoed, _Echoed_stub);
    }
...
#endif //__dbusxx__echo_introspect_h__PROXY_MARSHAL_H
